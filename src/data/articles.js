export const articles = [
  {
    id: "15-ways-to-cut-100-calories",
    title: "15 Ways To Cut 100 Calories A Day",
    isPremium: true,
    excerpt: "Modest changes to your diet add up. Cutting just 100 calories a day translates into a 10 pound weight loss in one year.",
    content: `Modest changes to your diet add up. Cutting just 100 calories a day translates into a 10 pound weight loss in one year.
...
Losing weight is easy when you cut calories in places where they won't be missed. Eat a little less each day, and exercise regularly so you can reach your fitness goals.`
  ...
  {
    id: "count-calories-right-way",
    title: "How To Count Calories The Right Way",
    isPremium: true,
    excerpt: "Counting calories might seem difficult, but it’s one of the most effective ways to lose weight.",
    content: `Counting calories might seem difficult, but it’s one of the most effective ways to lose weight. After all, the only thing you really need to do to ensure weight loss is make sure you’re using more calories than you’re taking in. 
...
With the right, accurate information, you’ll achieve your weight loss goals in no time.`
  ...
  {
    id: "ketosis-fat-loss",
    title: "Ketosis and Fat Loss",
    isPremium: false,
    excerpt: "There have been many diets over the years that have promised weight loss, but how many actually work?",
    content: `There have been many diets over the years that have promised weight loss and general improvements in body composition, but how many of them actually work - and at what cost? 
...
There’s no doubt about it - healthy eating leads to a healthy lifestyle resulting in a healthy weight, greater vitality, and increased satisfaction in life.`
  ...
  {
    id: "benefits-meal-repetition",
    title: "Lose Weight: 5 Surprising Benefits to Meal Repetition",
    isPremium: false,
    excerpt: "Have you ever considered eating the same type of meals each day? It makes meal planning easier and supports weight loss.",
    content: `Have you ever considered eating the same type of meals each day? It makes meal planning and shopping easier, and depending on your food choices, supports weight loss as well.
...
2. Junk food is less tempting. When you serve healthy and delicious meals that are familiar, you won't be tempted by junk food during the day.
